            ...
            <div className="contact__container container grid">
                <div className="contact__data">
                    ...
                    <p className="contact__description">
                        Feel free to  get in  touch with me. I am alwals open to discussing
                    ...
                    <div className="contact__info">
                        <div className="info__item">
                            ...
                            <div>
                                ...
                                <h4 className="info__desc">brunons.contato@gmail.com</h4>
                            </div>
                        </div>
                        <div className="info__item">
                            ...
                            <div>
                                ...
                                <h4 className="info__desc">+55 11 949964321</h4>
                            </div>
                        </div>
                    </div>
